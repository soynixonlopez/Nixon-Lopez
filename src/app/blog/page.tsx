      ...
      <main className="min-h-screen bg-white pt-[calc(4.5rem+env(safe-area-inset-top,0px))] dark:bg-slate-950">
        <section className="relative isolate overflow-hidden">
          <div
            ...
            aria-hidden
          />
          <div className="container-padding relative mx-auto max-w-6xl py-12 text-center sm:py-16">
        ...
        <section className="container-padding mx-auto max-w-6xl pb-16 sm:pb-24">
          {posts.length === 0 ? (
