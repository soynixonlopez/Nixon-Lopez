...
export const QUOTE_SERVICES: ServiceDef[] = [
  ...
  },
  {
    ...
    price: 150,
    offerPoints: [
      'Rediseño visual de las páginas ya existentes.',
      'Ajustes de contenido SEO, hooks y llamadas a la acción.',
      'Optimización e integración de imágenes en el diseño.',
      'Sin nuevas páginas ni nuevas funcionalidades.',
      'Ideal para WordPress u otra web ya publicada.',
    ],
    needsPages: false,
